...
import { Text, View, StyleSheet, ImageBackground, StatusBar, SafeAreaView, Image } from 'react-native'
import MapView, {Marker} from 'react-native-maps'
import axios from 'axios'


export default class ISS_location extends Component{
    constructor(){
        super()
        this.state={
            location:{}
    ...
    render(){
        ...
        return(
            ...
            <Text style={styles.titleText}>ISS_location</Text>
            </View>
